(function () {
    ...
    function choosePatientForForm(definition, mount) {
        ...
        mount.querySelector('.careforms-muted').textContent = 'Starting ' + definition.name;
        var input = mount.querySelector('input[type="search"]');
        var list = mount.querySelector('.careforms-patient-picker-list');
        ...
        loadPatients().then(function (patients) {
            function renderList() {
                ...
                filtered.forEach(function (patient) {
                    ...
                    button.type = 'button';
                    button.className = 'careforms-patient-choice';
                    ...
                    button.addEventListener('click', function () { openNewForm(definition, mount, patient); });
            ...
            list.innerHTML = '<div class="careforms-empty-state"><h3>Could not load patients</h3><p></p></div>';
    ...
    function patientValues(patient) {
        ...
        return {
            ...
            mr_number: patient.medicalRecordNumber,
    ...
    function openNewForm(definition, mount, patient) {
        ...
        window.CareForms.FormRenderer.render(definition,mount,{values:patientValues(patient),patient:patient,onSaveDraft:function(data,b){saveDraft(definition,data,b,mount);},onSubmit:function(data,b){submitForm(definition,data,b,mount);}});
    }
    ...
    function renderSubmission(definition, submission, mount) {
        ...
        window.CareForms.FormRenderer.render(definition,mount,{values:submission.data||{},patient:activePatient,readOnly:submission.status==='submitted',backLabel:'Back to My Work',onSaveDraft:function(data,b){saveDraft(definition,data,b,mount);},onSubmit:function(data,b){submitForm(definition,data,b,mount);}});
    }
